...
<header class = "headfoot">
    ...
    <body>
		<div>
		   ...
		   <h1 style="font-family:Columbina; font-size:40px; color:white; padding-left:45%; padding-top:2%;">Новости</h1>
			...
			<div class="content-top" style="justify-content:flex-start;">
				<div style="width:72%;">
