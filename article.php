...
<body>
	...
	<div>
		<h1 style="display:inline; font-family:Columbina; font-size:40px; color:white; padding-left:45%; padding-top:2%;">Статья</h1>
	...
	<div class="content" style="background-color:silver; border-color:black; border-width:2px; border-style:solid; border-radius:1em; height:40em;
				width:80%; margin-top:2%; margin-left:10%;">
		<h1>Сюда кладём контент</h1>
	</div>
