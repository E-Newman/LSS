...
<?php if(empty($_SESSION['login'])){           
		...
		$_SESSION['prevpage'] = 'articles/drego/drego.php';
...
<body>
	...
	<div class="content" style="background-color:silver; border-color:black; border-width:2px; border-style:solid; border-radius:1em;
		...
		<p class="arttext">
			...
			<br><br> 
			Умеет плакать, видеть в темноте, дышать под водой. Хорошо плавает. Ему покровительствует Луна. В полнолуние с помощью ритуального танца может
			получить от неё силы.
			<br><br>
			...
			Второй — это медицинский рюкзачок, где хранятся медикаменты и медицинский инвентарь, представляющий собой футляр с медицинскими инструментами,
			сделанными из чистейшего серебра, а также серебряная нить, благословлённая магами исцеления.
		</p>
	</div>
