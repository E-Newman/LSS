...
<body>
	...
	<div class="content" style="background-color:silver; border-color:black; border-width:2px; border-style:solid; border-radius:1em;
		...
		<p class="arttext">
			...
			Сказания утверждают, что храм построен на том месте, где и произошло творение драконов. Храм служит не только объектом культа, но и защитой
			от вторжения. Из-за него на территории всей столицы невозможно передвигаться с помощью прыжка, телепортации или портала. Кроме того, для
			защиты города границы с соседними мирами сдвинуты или подчищены, так что и по граням туда попасть тоже нельзя.
